...
const DashboardSidebar: React.FC = () => {
  const navLinks = [
    { to: '/dashboard', label: 'Dashboard', icon: <DashboardIcon active={false} />, activeIcon: <DashboardIcon active={true} /> },
    { to: '/order-history', label: 'Order History', icon: <OrderHistoryIcon active={false}/>, activeIcon: <OrderHistoryIcon active={true}/> },
    { to: '/cart', label: 'Shopping Cart', icon: <ShoppingCartIcon active={false}/>, activeIcon: <ShoppingCartIcon active={true}/> },
    { to: '/settings', label: 'Settings', icon: <SettingsIcon active={false}/>, activeIcon: <SettingsIcon active={true}/> },
    { to: '/logout', label: 'Log-out', icon: <LogoutIcon active={false}/>, activeIcon: <LogoutIcon active={true}/> },
  ];
